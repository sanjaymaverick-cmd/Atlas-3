...
const units = [
  { id: "u1", projectId: "p_av", towerId: "t2", code: "AVA-0101", status: "available", kind: "flat", floor: 1, price: 1 },
  { id: "u2", projectId: "p_av", towerId: "t2", code: "AVA-0102", status: "booked", kind: "flat", floor: 1, price: 1 },
  { id: "u3", projectId: "p_av", towerId: "t3", code: "AVA-0103", status: "available", kind: "flat", floor: 1, price: 1 },
  { id: "u4", projectId: "p_sf", towerId: "t2", code: "SFA-0101", status: "available", kind: "flat", floor: 1, price: 1 },
];
...
test("available list is project-filtered and does not require typing prefixes", () => {
  ...
  assert.deepEqual(list.map((u) => u.code), ["AVA-0101", "AVA-0103"]);
});

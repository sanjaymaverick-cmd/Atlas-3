...
3. Self-dues (`Due from SATYAM BUILDCOM - SBC` on BUILDCOM) can appear from that copy. Do not pick Due from _this same_ LLP. Do not delete those leaves this week.

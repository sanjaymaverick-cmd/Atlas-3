...
window first, then **Site + Stores (4–8, 20)**, then **Finance + Legal (9, 10, 18,
19)**, with MD and Design running throughout.
...
`ui-ux-pro-max` skill to answer one question per screen: *would a 45-year-old site
supervisor with a 5-inch phone and dusty hands get this right the first time?*

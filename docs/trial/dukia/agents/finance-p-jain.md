...
- Recorded funding picture (ops document, not a voucher): d_j7g9wvfn:Funding picture — Aerovista land equity + construction 60% SBI / 40% partner+advances:quarantine
- Land will be partner capital. Construction later: 60% SBI, 40% partners + booking advances.
- Did not post to ERPNext (posting off).
...
- Partner-capital land payment recorded as ops document (not posted): d_13eqwogj:Partner capital — Aerovista land (ops record, not ERPNext voucher):quarantine
- ERPNext posting still off. Atlas posted nothing.
...
## 2024-07-15 — fl — av — DUKIA / bank sanction note

### Work completed

- bank sanction note (registerDocument)
- Result: ok

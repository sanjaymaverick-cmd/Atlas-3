...
function DrawingsDesk() {
  ...
  return (
    <div>
      ...
      />
      <GateBanner>
        Local demo: the file copy stays in this browser (about 1.2 MB max). DWG/IFC is stored, not
        opened in 3D. Originals for issue still go through Documents if you need four-eyes export.
      </GateBanner>
      <Card className="mb-6 grid gap-3 p-5 sm:grid-cols-2">
        ...
        <Field label="Title">
          <Input
            ...
            placeholder="Tower A typical floor"
          />
        </Field>
      ...
      <div className="space-y-2">
        {rows.length === 0 ? (
          <p className="text-sm text-muted">No drawings on this company slice.</p>
        ) : null}
        {rows.map((d) => {

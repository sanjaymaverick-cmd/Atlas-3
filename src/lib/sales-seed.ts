...
export const SCORE_MODELS: ScoringModel[] = [
  {
    ...
    notes: "Fallback when the CatBoost process is down. Calibrated, imbalance-aware.",
  ...
  },
  {
    ...
    kind: "catboost",
    version: "1.0",
    trainedAt: "2026-08-23T00:00:00+05:30",
    metrics: {},
    featureList: FEATURE_LIST,
    active: true,
    isActive: true,
    createdAt: "2026-08-01T00:00:00+05:30",
    notes: "Native CatBoost via cat_features on services/scoring (:8091). This host does not re-implement Ordered Target Statistics. Unreachable → hybrid.",
    note: "Native CatBoost via cat_features. Bound to services/scoring on this host.",
  },
  {
    id: "m_xgb",
    name: "XGBoost",

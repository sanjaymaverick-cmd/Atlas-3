...
export const NAV: Array<{
  ...
  { to: "/app/approvals", label: "Waiting for a yes", icon: ListChecks, roles: NAV_ROLES.approvals, group: "today" },
  ...
  { to: "/app/land", label: "Land papers", icon: Landmark, roles: NAV_ROLES.land, group: "build" },

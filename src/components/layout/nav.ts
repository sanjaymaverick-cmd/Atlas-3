...
export const NAV: Array<{
  ...
  },
  {
    ...
    label: "Documents",
    icon: FileStack,
    roles: NAV_ROLES.documents,
    group: "build",
  },
  {
    to: "/app/drawings",
    label: "Drawings and plans",
    icon: PenLine,
    roles: NAV_ROLES.drawings,
    group: "build",
  },
  {
    to: "/app/land",
    ...
    icon: Landmark,
    roles: NAV_ROLES.land,
    group: "build",
  },
  {
    to: "/app/commercial",
    label: "Vendors and orders",
    icon: Truck,
    roles: NAV_ROLES.commercial,
    group: "build",
  },
  {
    to: "/app/quotations",
  ...
  },
  {
    ...
    label: "Materials",
    icon: Ruler,
    roles: NAV_ROLES.controls,
    group: "build",
  },
  {
    to: "/app/changes",
    label: "Site questions and quality",
    icon: GitBranch,
    roles: NAV_ROLES.changes,
    group: "build",
  },
  {
    to: "/app/customers",
  ...
  { to: "/app/crm", label: "Sales partners", icon: Handshake, roles: NAV_ROLES.crm, group: "sell" },
  {
    ...
    roles: NAV_ROLES.sales,
    group: "sell",
  },
  {
    to: "/app/sales/inventory",
    label: "Flats and shops",
    icon: Layers,
    roles: NAV_ROLES.salesInventory,
    group: "sell",
  },
  {
    to: "/app/sales/channel",
    label: "Agent daily work",
    icon: Handshake,
    roles: NAV_ROLES.salesChannel,
    group: "sell",
  },
  {
    to: "/app/sales/company",
    label: "Agency office",
    icon: Contact,
    roles: NAV_ROLES.salesCompany,
    group: "sell",
  },
  {
    to: "/app/sales/pipeline",
    label: "Buyer leads",
    icon: Workflow,
    roles: NAV_ROLES.salesPipeline,
    group: "sell",
  },
  {
    to: "/app/sales/handover",
    label: "Give keys",
    icon: KeyRound,
    roles: NAV_ROLES.salesHandover,
    group: "sell",
  },
  {
    ...
    label: "Sales numbers",
    icon: BarChart3,
    roles: NAV_ROLES.salesAnalytics,
    group: "sell",
  },
  {
    ...
    icon: Plug,
    roles: NAV_ROLES.salesIntegrations,
    group: "sell",
  },
  {
